<template>
  <main class="main">
    <div class="main__container container" data-aos="zoom-in">
      <section class="section-main" v-if="Object.keys(SELECTED_CARD).length !== 0">
        <div class="section-main__container">
          <div class="section-main__card main-card">
            <!-- изображение -->
            <div class="main-card__img">
              <picture
                ><source :srcset="API_DOMAIN + SELECTED_CARD.personal_img" type="image/avif" />
                <source :srcset="API_DOMAIN + SELECTED_CARD.personal_img" type="image/webp" />
                <img
                  loading="lazy"
            ...
            <div class="main-card__info">
              <div class="main-card__top">
                <!-- тайтл -->
                <h2 class="main-card__title title-h2">{{ SELECTED_CARD.name }}</h2>
                <!-- сабтайтл -->
              ...
              <div class="main-card__bottom">
                ...
                ><!-- ссылк емейла -->
                <a :href="'mailto:'+ SELECTED_CARD.email" class="main-card__link"
