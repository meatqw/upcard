    ...
    <div class="header__container">
      ...
      <nav :class="menuShowClass" title="Главное меню" data-menu>
        <ul class="list-reset nav__list">
          <li class="nav__item" style="cursor: pointer;" @click="routingFromMenu('/account-cards')">
            <a class="nav__link">
              <div class="nav__left">
              <i class="fa-solid fa-list"></i> <span>Мои визитки</span>
            </div></a>
          </li>
          <li class="nav__item" style="cursor: pointer;" @click="routingFromMenu('/personal')">
            <a class="nav__link"
            ><div class="nav__left">
          ...
          <li class="nav__item" style="cursor: pointer;" @click="routingFromMenu('/subscriptions')">
            <a class="nav__link"
            ><div class="nav__left">
          ...
          <li class="nav__item" style="cursor: pointer;" @click="routingFromMenu('/account-settings')">
            <a class="nav__link"
            ><div class="nav__left">
          ...
          <li class="nav__item" style="cursor: pointer;" @click="routingFromMenu('/account')">
            <a class="nav__link"
            ><div class="nav__left">
      ...
      <div class="header__right" v-if="!showHeadInfo">
        ...
        <div class="header__balance header-balance" >
          ...
          <span class="header-balance__value">200 руб.</span>
        </div>
        <!-- кнопка создания новой визитки -->
        <button @click="routingFromMenu('/personal')"
